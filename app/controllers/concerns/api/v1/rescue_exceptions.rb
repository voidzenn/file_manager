  ...
  module V1
    module RescueExceptions
      ...
      def rescue_rename_folder_error error
        render_error_response I18n.t("errors.models.folder.#{error.message}")[:message], :unprocessable_entity
      end

      def rescue_rename_file_error error
        render_error_response I18n.t("errors.models.file_upload.#{error.message}")[:message], :unprocessable_entity
      end
